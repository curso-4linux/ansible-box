...
vms = {
  'ansible-server' => {'memory' => '1024', 'cpus' => 1, 'ip' => '200', 'box' => 'devopsbox/debian-10.11', 'provision' => 'provision/ansible/ansible-server.yaml'},
  'webserver1' => {'memory' => '1024', 'cpus' => 1, 'ip' => '201', 'box' => 'devopsbox/ubuntu-20.04', 'provision' => 'provision/ansible/webserver1.yaml'},
  'webserver2' => {'memory' => '1024', 'cpus' => 1, 'ip' => '202', 'box' => 'devopsbox/centos-8.5', 'provision' => 'provision/ansible/webserver2.yaml'},
  'dbserver' => {'memory' => '1024', 'cpus' => 1, 'ip' => '203', 'box' => 'devopsbox/ubuntu-20.04', 'provision' => 'provision/ansible/dbserver.yaml'}
}
...
Vagrant.configure('2') do |config|
  ...
  vms.each do |name, conf|
    ...
    config.vm.define "win-client" do |win10|
